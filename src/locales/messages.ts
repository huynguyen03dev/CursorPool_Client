export const messages = {
  'zh-CN': {
    ...
    dashboard: {
      ...
      updateWebView2Message: 'New version found, please visit the official website to download',
      updateChecking: 'Checking for updates...',
      updateDownloading: 'Downloading update ({percentage})...',
      updateInstalling: 'Installing update, application will restart...',
    ...
    fileSelect: {
      fileSelectSuccess: 'File selection successful, system has found and saved Cursor path',
      hookApplySuccess: 'Hook applied successfully!',
      hookRestoreSuccess: 'Hook restored successfully!',
      openSystemPreferences:
        'System preferences opened, please grant the required permissions to the application',
      openSystemPreferencesFailed: 'Failed to open system preferences, please open manually',
      permissionValidationFailed:
        'Permission validation failed, please ensure permissions are properly granted',
    },
    login: {
      title: 'Login',
    ...
    systemControl: {
      ...
      messages: {
        ...
        macOSPermissionError: 'Unable to terminate Cursor process, system permission required',
      },
      history: {
        applyHook: 'Apply Hook',
        restoreHook: 'Restore Hook',
    ...
    common: {
      ...
      forgotPassword: 'Forgot password?',
      unknown: 'Unknown',
      notBound: 'Local Cursor not logged in',
      verified: 'Verified',
